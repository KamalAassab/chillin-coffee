...
const FUITestimonialWithSlide = ({ testimonials = defaultTestimonials, title, subtitle, className }: FUITestimonialWithSlideProps) => {
            ...
            <div className="w-full mx-auto px-4 md:px-10">
                {(title || subtitle) && (
                    <div className='mb-6 flex flex-col items-center text-center'>
                        {title && (
                            <h2 className={cn("w-fit block mx-auto text-6xl md:text-8xl font-display font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-500 to-red-600 mb-6 md:mb-8", className)}>
                                {title}
                            </h2>
                        )}
                        {subtitle && (
                        ...
                        <a
                            href="https://www.google.com/maps/search/?api=1&query=Chillin+Coffee+Casablanca"
                            target="_blank"
