        ...
        <div className="flex flex-col items-center">
          ...
          >
            <Image
              ...
              alt="Chillin Coffee Casablanca - Your destination for artisan coffee, billiard, and gaming"
              width={240}
              height={240}
          ...
          <nav className="mb-12 w-full max-w-7xl">
            <div className="grid grid-cols-3 gap-2 md:flex md:flex-wrap md:justify-center md:gap-3">
              {[
                { label: "Our Space", href: "#about", icon: Info, color: "blue" },
                { label: "Coffee & Menu", href: "#menu", icon: Coffee, color: "red" },
                { label: "Games & Fun", href: "#games", icon: Gamepad2, color: "blue" },
                { label: "Moments", href: "#gallery", icon: ImageIcon, color: "red" },
                { label: "Find Us", href: "#location", icon: MapPin, color: "blue" },
                { label: "Reserve", href: "#book", icon: Calendar, color: "red" },
              ].map((link) => {
          ...
          <div className="mb-8 flex space-x-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative p-3 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm transition-all duration-300 hover:scale-110 hover:bg-green-600/10 hover:border-green-500/50 hover:shadow-[0_0_20px_rgba(34,197,94,0.3)]"
              aria-label="WhatsApp"
            >
              <svg
                viewBox="0 0 24 24"
                fill="currentColor"
                className="w-6 h-6 text-zinc-400 transition-colors duration-300 group-hover:text-green-500"
              >
          ...
          <div className="text-center space-y-2">
            <p className="text-sm text-zinc-500 font-bold">
              © {currentYear} <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-purple-500 to-red-600">Chillin Coffee</span>. All rights reserved.
            </p>
