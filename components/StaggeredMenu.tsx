            ...
            {mounted && createPortal(
                ...
                >
                    ...
                    <aside
                        ...
                        ref={panelRef}
                        className="staggered-menu-panel absolute top-0 right-0 h-full bg-brand-blue flex flex-col p-[4rem_1rem_1.5rem_1rem] sm:p-[6rem_2rem_2rem_2rem] overflow-y-auto z-10 pointer-events-auto shadow-2xl rounded-l-3xl"
                    >
                        ...
                        <div className="sm-panel-inner flex-1 flex flex-col gap-3 sm:gap-5">
                            ...
                            {/* Social Media Icons */}
                            <div className="sm-socials mt-auto pt-4 sm:pt-8 flex flex-col gap-3 sm:gap-4" aria-label="Social links">
