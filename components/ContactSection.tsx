...
import { ArrowRight, MapPin, Gamepad2, Dice5, Gamepad, Mic, Music, Clock, Phone, Mail } from "lucide-react";
...
export default function ContactSection() {
  ...
  return (
    <section id="location" className="relative min-h-screen flex items-center justify-center py-12 px-6 bg-slate-950 overflow-hidden">
      {/* Background */}
      ...
      <div className="max-w-7xl mx-auto w-full h-full flex flex-col justify-center relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-x-20 lg:gap-y-8">
          ...
          >
            <div className="grid grid-cols-1 gap-3 md:gap-4 h-full">
              ...
              <div className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-brand-blue/20 via-brand-blue/10 to-zinc-900/50 border border-brand-blue/30 p-5 md:p-6 shadow-[0_0_20px_rgba(27,79,216,0.2)] hover:shadow-[0_0_30px_rgba(27,79,216,0.4)] transition-all duration-300 hover:border-brand-blue/50">
                ...
                <motion.div
                  className="absolute top-1/2 right-4 opacity-20 group-hover:opacity-30 transition-opacity"
                  animate={{ y: [0, -5, 0], rotate: [0, 3, 0] }}
                  transition={{ duration: 4.2, repeat: Infinity, ease: "easeInOut", delay: 0.3 }}
                >
                  <Music size={26} className="text-brand-blue" />
                </motion.div>
                ...
                <div className="relative z-10 flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-body font-bold text-lg md:text-xl text-white tracking-tight mb-2" style={{ fontWeight: 700 }}>Our Location</h4>
                    <p className="text-zinc-300 font-display text-sm md:text-base leading-relaxed">
                      29 Rue Al Woroud, Casablanca 20250
                    </p>
                  </div>
                </div>
                {/* Gaming glow effect */}
              ...
              <div className="group relative overflow-hidden rounded-xl bg-gradient-to-br from-brand-red/20 via-brand-red/10 to-zinc-900/50 border border-brand-red/30 p-5 md:p-6 shadow-[0_0_20px_rgba(255,87,87,0.2)] hover:shadow-[0_0_30px_rgba(255,87,87,0.4)] transition-all duration-300 hover:border-brand-red/50">
                ...
                <motion.div
                  className="absolute top-1/3 right-2 opacity-20 group-hover:opacity-30 transition-opacity"
                ...
                <div className="relative z-10 flex items-start gap-4">
                  <Clock size={24} className="text-brand-red mt-0.5 drop-shadow-[0_0_8px_rgba(255,87,87,0.6)] group-hover:scale-110 transition-transform" />
                  <div className="flex-1">
                    <h4 className="font-body font-bold text-lg md:text-xl text-white tracking-tight mb-2" style={{ fontWeight: 700 }}>Opening Hours</h4>
                    <p className="text-zinc-300 font-display text-sm md:text-base leading-relaxed">
                      Daily from <span className="text-white font-semibold">10:00 AM</span> to <span className="text-white font-semibold">00:00 AM</span>
                    </p>
                  </div>
                </div>
                {/* Gaming glow effect */}
              ...
              >
                ...
                <motion.div
                  className="absolute top-1/2 left-6 opacity-20 group-hover:opacity-30 transition-opacity"
                  animate={{ y: [0, -6, 0], rotate: [0, 4, 0] }}
                  transition={{ duration: 4.8, repeat: Infinity, ease: "easeInOut", delay: 0.2 }}
                >
                  <Music size={25} className="text-brand-blue" />
                </motion.div>

                <div className="relative z-10 flex items-start gap-4">
                  <Phone size={24} className="text-brand-blue mt-0.5 drop-shadow-[0_0_8px_rgba(27,79,216,0.6)] group-hover:scale-110 transition-transform" />
                  <div className="flex-1 flex items-center justify-between">
                    <div>
                      <h4 className="font-body font-bold text-lg md:text-xl text-white tracking-tight mb-2" style={{ fontWeight: 700 }}>Call Us</h4>
              ...
              {/* Email Card */}
              <a
                href="mailto:chillin.coffee@gmail.com"
              ...
              >
                ...
                <motion.div
                  className="absolute top-1/3 left-4 opacity-20 group-hover:opacity-30 transition-opacity"
                  animate={{ y: [0, -8, 0], rotate: [0, -5, 0] }}
                  transition={{ duration: 5.2, repeat: Infinity, ease: "easeInOut", delay: 0.5 }}
                >
                  <Mic size={23} className="text-brand-red" />
                </motion.div>

                <div className="relative z-10 flex items-start gap-4">
                  <Mail size={24} className="text-brand-red mt-0.5 drop-shadow-[0_0_8px_rgba(255,87,87,0.6)] group-hover:scale-110 transition-transform" />
                  <div className="flex-1 flex items-center justify-between">
                    <div>
                      <h4 className="font-body font-bold text-lg md:text-xl text-white tracking-tight mb-2" style={{ fontWeight: 700 }}>Email Us</h4>
                      <p className="text-zinc-300 font-display text-sm md:text-base">
                        chillin.coffee@gmail.com
                      </p>
                    </div>
          ...
          >
            {/* Map Facade / Embed */}
            <iframe
              src="https://www.google.com/maps?q=29+Rue+Al+Woroud,+Casablanca&z=16&output=embed"
            ...
            <div className="absolute bottom-6 left-6 right-6 flex justify-center">
              <a
                href="https://maps.app.goo.gl/8yNw9K1KZeF1T5mR6"
                target="_blank"
