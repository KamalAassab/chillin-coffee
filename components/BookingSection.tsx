...
import { Calendar as CalendarIcon, Clock, User, Users, Phone, MessageSquare, Gamepad2, Send } from "lucide-react";
...
export default function BookingSection() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const message = `Hello Chillin Coffee Team! ⚄⚂
...
Looking forward to your confirmation! To clarify any details, feel free to ask. Thank you! ♡`;
    ...
    const whatsappUrl = `https://wa.me/212661948012?text=${encodedMessage}`;
  ...
  return (
    <section id="book" className="relative w-full overflow-hidden bg-slate-950 flex flex-col lg:flex-row min-h-screen lg:min-h-[100vh] pb-0">
      {/* Background */}
      ...
      {/* Middle Column: Form */}
      <div className="relative z-10 w-full lg:w-[500px] xl:w-[600px] lg:flex-none lg:h-full shrink-0 flex flex-col items-center justify-center px-4 pt-4 pb-0 md:px-4 md:pt-8 md:pb-8 lg:p-8 bg-zinc-950">
        <motion.div
        ...
        >
          ...
          >
            <h2 className="w-fit block mx-auto text-5xl md:text-7xl font-display font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-purple-500 to-red-600">
              Secure Your Spot
            </h2>
          </motion.div>
          ...
          <div className="w-full bg-brand-blue/90 backdrop-blur-xl border border-brand-blue/30 p-5 md:p-8 rounded-2xl shadow-[0_0_50px_-12px_rgba(27,79,216,0.5)] relative overflow-y-auto lg:overflow-visible scrollbar-hide">
            <form onSubmit={handleSubmit} className="space-y-4 relative z-10">
                ...
                <div className="group space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full bg-white/10 border border-white/20 rounded-lg pl-9 pr-3 py-2.5 text-white placeholder:text-white/50 focus:outline-none focus:border-white/50 focus:bg-white/20 focus:shadow-[0_0_20px_-5px_rgba(255,255,255,0.3)] transition-all text-[11px] lg:text-sm"
                    />
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="group space-y-1.5">
                  <label className="text-[10px] lg:text-xs font-bold text-white/80 uppercase tracking-widest group-focus-within:text-white transition-colors">
                    What's The Plan? <span className="text-brand-red">*</span>
                  </label>
                  <div className="relative">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        <Button
                          variant="outline"
                          className={cn(
                            "w-full border rounded-lg pl-9 pr-3 py-2.5 h-auto text-white justify-start font-normal transition-all text-[11px] lg:text-sm",
                            formData.type
                      ...
                      <DropdownMenuContent className="w-[200px] bg-brand-blue border-white/30 text-white shadow-xl">
                        {["Coffee & Chill", "Board Games", "Billiard & Snooker", "Karaoke Night", "Co-working", "Birthday Party", "Private Event"].map((type) => (
                          <DropdownMenuItem
                            key={type}
                ...
                <div className="group space-y-1.5">
                  <label className="text-[10px] lg:text-xs font-bold text-white/80 uppercase tracking-widest group-focus-within:text-white transition-colors">
                    People <span className="text-brand-red">*</span>
                  </label>
                  <div className="relative">
                    ...
                    <DropdownMenu>
                      <DropdownMenuTrigger asChild>
                        ...
                        >
                          {formData.guests ? `${formData.guests} ${parseInt(formData.guests) === 1 ? 'Person' : 'People'}` : "Select People"}
                        </Button>
                      </DropdownMenuTrigger>
              ...
              <div className="group space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <textarea
                    name="notes"
                    rows={2}
                    placeholder="Special requests, games you want to play, dietary needs..."
                    value={formData.notes}
                    onChange={handleChange}
                    className="w-full bg-white/10 border border-white/20 rounded-lg pl-9 pr-3 py-2.5 text-white placeholder:text-white/50 focus:outline-none focus:border-white/50 focus:bg-white/20 focus:shadow-[0_0_20px_-5px_rgba(255,255,255,0.3)] transition-all resize-none text-[11px] lg:text-sm"
                  />
                </div>
              </div>
              ...
              <div className="pt-2 relative">
                ...
                >
                  ...
                  <div className="relative flex items-center justify-center gap-3 z-20">
                    <span className="font-display font-bold text-white tracking-widest uppercase text-sm drop-shadow-[0_2px_4px_rgba(0,0,0,0.3)]">Book Now</span>
